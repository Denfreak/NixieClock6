...
/* Исходная версия: ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
  ...
  Добавлено в версии PE 2.1.1:
  - коррекция температуры с помощью левой и правой кнопок в режиме отображения температуры
*/
...
/*
  ...
  - При демонстрации температуры, влажности, давления, времени будильника:
    ...
    только для температуры, влажности, давления:
    - M       (кратко) - отмена/включение автоматического переключения на следующий параметр (freeze)
    только для температуры в режиме freeze:
    - М       (удержание) - сброс коррекции температуры
    - "минус" (кратко) - коррекция температуры (десятые доли) в сторону уменьшения
    -         (удержание) - коррекция температуры на 1 градус в сторону уменьшения
    - "плюс"  (кратко) - коррекция температуры (десятые доли) в сторону увеличения
              (удержание) - коррекция температуры на 1 градус в сторону увеличения
